...
=== Added java codes as samples

The original does not show the source of the following Java classes at all.
...
So I guessed how these should be and added them in the sample project.