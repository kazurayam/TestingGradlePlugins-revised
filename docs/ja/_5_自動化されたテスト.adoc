...
link:https://docs.gradle.org/current/javadoc/org/gradle/testkit/runner/GradleRunner.html[`org.gradle.testkit.runner.GradleRunner`] クラスの助けを必要とします。`GradleRunner`クラスは
